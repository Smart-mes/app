<template>
  <view>
    ...
    <view v-show="!buttonHide" class="submit">
      <slot name="submit">
        <u-row gutter="20">
            <u-col span="6"><u-button type="default"  @click="resetForm()">重置</u-button></u-col>
            <u-col span="6"><u-button  type="primary" :loading="loading"  @click="submitForm()"> 提交 </u-button></u-col>
        </u-row>    
      </slot>
    </view>
    <u-select
